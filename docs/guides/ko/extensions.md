...
`extension/{family}` typed builder를 우선 사용하세요. 정확한 schema는 각 TypeScript 상세
문서에서, builder 동작은 [Go Extension 레퍼런스](../../reference/go/EXTENSIONS.md)에서 확인합니다.
...
[TypeScript 상세](../../reference/typescript/extensions/config.md)
...
[TypeScript 상세](../../reference/typescript/extensions/oauth.md)
...
[TypeScript 상세](../../reference/typescript/extensions/apikey.md)
...
[TypeScript 상세](../../reference/typescript/extensions/command.md) ·
...
[TypeScript 상세](../../reference/typescript/extensions/widget.md)
...
[TypeScript 상세](../../reference/typescript/extensions/customtab.md)
...
[TypeScript 상세](../../reference/typescript/extensions/hook.md)
...
[TypeScript 상세](../../reference/typescript/extensions/polling.md)
...
[TypeScript 상세](../../reference/typescript/extensions/calendar.md)
...
[TypeScript 상세](../../reference/typescript/extensions/store.md)
...
[TypeScript 상세](../../reference/typescript/extensions/datasource.md) ·
...
[TypeScript 상세](../../reference/typescript/extensions/messaging.md)
...
[TypeScript 상세](../../reference/typescript/extensions/alf-task.md)
...
[TypeScript 상세](../../reference/typescript/extensions/notebook.md)
...
[TypeScript 상세](../../reference/typescript/extensions/mail-relay.md)

...
- Architecture と deployment: [アプリ開発完全ガイド](app-development.md)
- Function、Extension、WAM、authentication: [基本概念](concepts.md)
- Capability contract: [Extension 完全ガイド](extensions.md)
- 実行コード: [TypeScript tutorial](https://github.com/channel-io/app-tutorial-ts)、

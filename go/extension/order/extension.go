...
func (b *ExtensionBuilder) CancelOrder(handler appsdk.TypedHandlerFunc[CancelOrderInput, SuccessOutput]) *ExtensionBuilder {
	b.base.Func(FunctionCancelOrder, schemaregistry.Append(FunctionCancelOrder, appsdk.HandleProto(handler))...)
	return b
}

func (b *ExtensionBuilder) ReturnOrder(handler appsdk.TypedHandlerFunc[ReturnOrderInput, SuccessOutput]) *ExtensionBuilder {
	b.base.Func(FunctionReturnOrder, schemaregistry.Append(FunctionReturnOrder, appsdk.HandleProto(handler))...)
	return b
}

func (b *ExtensionBuilder) ExchangeOrder(handler appsdk.TypedHandlerFunc[ExchangeOrderInput, SuccessOutput]) *ExtensionBuilder {
...
func (b *ExtensionBuilder) ChangeShippingAddress(handler appsdk.TypedHandlerFunc[ChangeShippingAddressInput, SuccessOutput]) *ExtensionBuilder {
